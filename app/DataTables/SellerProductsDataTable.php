...
class SellerProductsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            ...
            $deleteBtn = "<a href='".route('admin.products.destroy', $query->id)."' class='ml-1 btn btn-danger delete-item'><i class='fas fa-trash-alt'></i></a>";
        ...
        ->addColumn('status', function($query){
            if ($query->status == 1){
                $button = '<label class="mt-2 custom-switch">
