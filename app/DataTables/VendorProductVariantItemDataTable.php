...
class VendorProductVariantItemDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                $editBtn = "<a href='".route('vendor.products-variant-item.edit', $query->id)."' class='btn btn-primary ml-1'><i class='far fa-edit'></i></a>";
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('product_variant_name')->width(250),
            Column::make('price'),
            Column::make('is_default')->width(100),
            Column::make('status'),
